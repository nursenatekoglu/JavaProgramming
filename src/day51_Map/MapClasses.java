...
public class MapClasses {
    ...
    public static void main(String[] args) {
        //    key     value
        Map <Integer, String> hashMap = new HashMap<>(); //random order, accepts null value
        ...
        Map<Integer, String> linkedHashMap = new LinkedHashMap<>(); //insertion order, accepts null value
